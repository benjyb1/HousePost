...
<head>
  ...
  <style>
    ...
    .header { background: #1a00cc; color: white; padding: 20px; border-radius: 8px; margin-bottom: 24px; }
    .highlight { color: #1200a0; font-weight: bold; }
    .address { background: #eef0ff; border-left: 4px solid #1a00cc; padding: 12px 16px; margin: 16px 0; }
